...
export function SignInPage() {
  ...
  async function handleGoogle() {
    ...
    // Google OAuth redirects away; loading stays true until redirect
  }
    ...
    <div style={{ background: 'var(--bg)', minHeight: '100dvh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px 16px' }}>
      <div style={{ width: '100%', maxWidth: '380px', display: 'flex', flexDirection: 'column', gap: '24px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
          <div className="font-extrabold" style={{ fontSize: '24px', color: 'var(--tx)' }}>Sign in</div>
          <div className="font-medium" style={{ fontSize: '13px', color: 'var(--tx3)' }}>Log dives, report conditions, plan tech dives.</div>
        </div>
